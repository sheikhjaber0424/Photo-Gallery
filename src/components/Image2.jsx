export default function Image2({ imageData }) {
  return (
    <div className="relative  border border-b-1 border-gray-300 rounded-lg">
      ...
      <input className="absolute top-2 left-2" type="checkbox"></input>
    </div>
  );
}
